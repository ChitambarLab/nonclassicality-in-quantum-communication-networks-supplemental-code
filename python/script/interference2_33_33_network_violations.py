...
"""
The goal of this script is to identify quantum resource configurations of the 3,3->3,3 compressed interference
...
inequalities demonstrate a quantum advantage.
"""
